...
/**
 * Official Google Gemini Logo (4-point dynamic curved spark)
 */
...
/**
 * Official Anthropic Claude Logo (14-spoke starburst spark mark)
 */
...
/**
 * Official Perplexity AI Logo (Woven interlocking ribbon knot)
 */
export function PerplexityIcon({ className = "w-4 h-4", size = 16 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
/**
 * Official Manus AI Logo (Autonomous Agent Silhouette Mark)
 */
export function ManusIcon({ className = "w-4 h-4", size = 16 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      aria-label="Manus AI"
    >
      <path d="M12 2L4 7v10l8 5 8-5V7l-8-5zm0 2.5l5.5 3.5L12 11.5 6.5 8 12 4.5zM5.5 9.2l5.5 3.5v6.1l-5.5-3.5V9.2zm13 6.1l-5.5 3.5v-6.1l5.5-3.5v6.1z" />
    </svg>
  );
}
